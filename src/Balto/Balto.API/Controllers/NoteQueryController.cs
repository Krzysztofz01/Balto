...
namespace Balto.API.Controllers
{
    ...
    {
        public NoteQueryController(IDataAccess dataAccess, IMapper mapper, IMemoryCache memoryCache, ILogger<NoteQueryController> logger) : base(dataAccess, mapper, memoryCache, logger)
        {
        }
