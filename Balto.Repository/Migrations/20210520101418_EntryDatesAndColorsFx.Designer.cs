...
namespace Balto.Repository.Migrations
{
    ...
    [Migration("20210520101418_EntryDatesAndColorsFx")]
    partial class EntryDatesAndColorsFx
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Balto.Domain.ProjectTableEntry", b =>
                {
                    ...
                    b.Property<long?>("UserFinishedId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Balto.Domain.RefreshToken", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Balto.Domain.Team", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Balto.Domain.ProjectTableEntry", b =>
                {
                    ...
                    b.HasOne("Balto.Domain.User", "UserAdded")
                        .WithMany("ProjectTableEntriesAdded")
                        .HasForeignKey("UserAddedId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Balto.Domain.User", "UserFinished")
                        .WithMany("ProjectTableEntriesFinished")
            ...
            modelBuilder.Entity("Balto.Domain.User", b =>
                {
                    b.HasOne("Balto.Domain.Team", "Team")
                        .WithMany("Users")
